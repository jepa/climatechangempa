...
We first average the Fish Model's Maximum Catch Potential (MCP) of 1995 to 2014 (last years of fisheries data from SAU) for each species for each one of the circulation models (GCM) that we work with (GFDL, MPIL, IPSL). Second, we average the 2005-2014 average for all models (To get the 10 years average; "today"). Third, we repeat the steps using the abundance data.
